...
var addresses = JSON.parse(fs.readFileSync('/home/ubuntu/workspace/data/zone2_clean.txt'));
...
async.eachSeries(addresses, function(value, callback) {
    ...
    fs.writeFile('zone2_clean+geocodes.txt', JSON.stringify(meetingsData, null, '\t'), function (err) { 
        if (err) 
        return console.log('Error');
        console.log('Wrote ' + meetingsData.length + ' entries to file ' + 'zone2_clean_geocodes.txt');
