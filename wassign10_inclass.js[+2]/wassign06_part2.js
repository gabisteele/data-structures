...
var addresses = JSON.parse(fs.readFileSync('/home/ubuntu/workspace/data/zone2_ALLaddresses.txt'));
...
async.eachSeries(addresses, function(value, callback) {
    ...
    var apiRequest = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + meetingAddress(value).split(' ').join('+') + '&key=' + apiKey; 
    var thisMeeting = new Object;
    thisMeeting.address = meetingAddress(value);
